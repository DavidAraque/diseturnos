...
if ($_POST['accion'] == 'VerServicios') {
    require_once('../config/conexion.php');
                $query = mysqli_query($mysqli, "SELECT id_servicio,nombre_servicio from db_servicios WHERE estado ='A'");
                $datos = array();
                while ($row = $query->fetch_assoc()) {
                    $datos[] = $row;
                }
...
if ($_POST['accion'] == 'VerModulos') {
    require_once('../config/conexion.php');
                $query = mysqli_query($mysqli, "SELECT id_modulo,nombre_modulo from db_modulos WHERE estado ='A'");
                $datos = array();
                while ($row = $query->fetch_assoc()) {
                    $datos[] = $row;
                }
