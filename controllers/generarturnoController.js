...
function servicios() {
    ...
    $.ajax({
        ...
        if (datos.status == true) {
            ...
            <div class="card-body">
              <div class="card-link badge ">
                <i style="font-size: 68px;" class="bx"></i>
              </div>
                ...
                .then(function (response) {
                    ...
                    if (Data.codigo == 0) {
                        ...
                        Swal.fire({
                            ...
                            html: '<div class="btn btn-white">' +
                                '<span  class="badgediseturnodiseturnos "><h1 style="color:black">' + Data.turno + '</h1></span>' +
                                '</div>',
